...
**Current `main` development version:** `3.2.0a8`
...
Spec Kitty currently ships stable `3.1.x` releases while `main` carries the active `3.2.0a8` prerelease/dev line.
...
| **main** | **3.2.0a8** | Active prerelease / development line | Install from a source checkout or a published prerelease tag |
...
After `3.2.0a8` is published, testers can install the exact prerelease with `pip install "spec-kitty-cli==3.2.0a8"` or opt into prereleases with `pip install --pre spec-kitty-cli`.
