...
def _resolve_placement(
    ...
    """Preserve the legacy seam signature unless a caller anchor is real."""
...
def _resolve_mission_topology(
    ...
    """Resolve topology with the optional caller anchor when present."""
    if mission_anchor_root is None:
...
def _commit_partition_group(
    ...
    *,
    ...
    if use_coord:
        ...
        worktree_root, commit_paths = mission_anchor_root or repo_root, files
