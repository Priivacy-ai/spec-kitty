...
_INSTRUCTIONS = (
    ...
    "`repo` — the credential-store key, host/owner/repo (e.g. "
    "github.com/acme/widget), under which `spec-kitty zeitgeist checkout` "
    "stored the team context — plus a bounded wait; neither accepts a relay "
    "URL or credential, and neither writes anything to disk. `timeout_s` is "
    "always clamped to a 90s honest reported-live ceiling."
)
