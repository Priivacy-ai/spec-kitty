"""Mission scanning and kanban assembly service (canonical home).
...
Shim note: ``src/dashboard/services/mission_scan.py`` is a temporary
re-export shim that defers to this module. It will be removed in a later
phase (Phase C, post-3.2.0). Do not add business logic to the shim — edit
this file instead.
"""
...
from specify_cli.missions.api_types import FeaturesListResponse, MissionContext
from specify_cli.status.api_types import KanbanResponse
