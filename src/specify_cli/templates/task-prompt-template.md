...
assignee: ""      # Optional friendly name
...
1. Scroll to the bottom of this file (Activity Log section)
...
Use the CLI to change WP status:
```bash
spec-kitty agent tasks move-task <WPID> --to <status> --note "message"
```
