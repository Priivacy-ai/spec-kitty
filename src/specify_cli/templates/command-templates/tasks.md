...
Work packages are generated directly in `kitty-specs/###-feature/` and committed to the feature planning branch. Worktrees are created later when implementing each work package.
