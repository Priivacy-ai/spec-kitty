...
def move_task(
    ...
    review_feedback_file: Annotated[
        Optional[Path],
        typer.Option(
            "--review-feedback-file", help="Path to review feedback file (required for --to planned unless --force)"
        ),
    ] = None,
    ...
    try:
        ...
        if (
            ...
            sync_reason = (
                "bootstrap from frontmatter lane {current_canonical_lane} before move-task transition"
