...
def build_parser() -> argparse.ArgumentParser:
    ...
    status.add_argument("--mission", dest="feature", help="Mission slug")
    ...
    verify.add_argument("--mission", dest="feature", help="Mission slug")
    ...
    accept.add_argument("--mission", dest="feature", help="Mission slug")
    ...
    merge.add_argument("--mission", dest="feature", help="Mission slug")
