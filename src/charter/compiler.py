...
def compile_charter(
    *,
    ...
    valid_local, local_errors = validate_local_support_declarations(list(interview.local_supporting_files))
    ...
    for decl in declarations:
        ...
        if decl.target_kind and decl.target_id:
            ...
            if overlap_key in {k.upper() for k in shipped_ids}:
                warning = f"Local support file overlaps shipped {decl.target_kind} {decl.target_id}; shipped content remains primary."
