...
The extractor (:mod:`charter.offering.drg.migration.extractor`) walks built-in
...
HAND_AUTHORED_EDGES: tuple[DRGEdge, ...] = (
    ...
    # charter.offering.missions.step_projection.iter_template_refs (step_projection.py:124,
