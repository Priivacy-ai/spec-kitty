...
Relocated from ``charter.context`` (charter-sync-sonar-remediation-01KZPPZW
...
``context.py`` <-> this-module import cycle); ``charter.context`` re-exports
...
from charter.charter_md_parsing import _extract_policy_summary
from charter.context_renderers.bootstrap_text import _render_bootstrap_text
...
from charter.context_state import _mark_action_loaded
