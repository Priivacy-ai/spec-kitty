...
| `spec-template.md` | Feature specification scaffold |
| `plan-template.md` | Implementation plan scaffold |
| `tasks-template.md` | Work package breakdown scaffold |
| `task-prompt-template.md` | Individual WP prompt file scaffold |
