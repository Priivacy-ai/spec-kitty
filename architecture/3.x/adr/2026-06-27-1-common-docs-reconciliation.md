# ADR: Common Docs Consolidation — Reconciliation of Metadata, Structure, Redirects, Glossary Read-Path, ADR Migration, and Curation

**Status:** Accepted

**Date:** 2026-06-27

**Deciders:** Architect Alphonso (design); five-lens adversarial squad (profile-loaded) — architect-alphonso ×2 (architecture + generated-docsite), doctrine-daphne (docs governance), paula-patterns (full-adoption path); operator/PO @xtfer (full-consolidation direction)

**Technical Story:** [#2165](https://github.com/Priivacy-ai/spec-kitty/issues/2165) (Common Docs adoption) under epic [#651](https://github.com/Priivacy-ai/spec-kitty/issues/651) (Public Site and Documentation Experience)

**Research ground truth:** [`docs/engineering_notes/651-docs-consolidation/index.md`](../../../docs/engineering_notes/651-docs-consolidation/index.md) · [`02-common-docs-standard.md`](../../../docs/engineering_notes/651-docs-consolidation/02-common-docs-standard.md) · [`03-target-structure-mapping.md`](../../../docs/engineering_notes/651-docs-consolidation/03-target-structure-mapping.md)
