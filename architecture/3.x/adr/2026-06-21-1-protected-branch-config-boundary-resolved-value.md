# Protected-branch configuration is a standalone boundary-resolved value, not a nested context sub-object

**Status:** Accepted

**Date:** 2026-06-21

**Deciders:** Stijn Dejongh (operator/PO); design squad — architect-alphonso, patterns-paula, randy-reducer (expert trio, profile-loaded) + a dialectic Proponent/Skeptic pair

**Technical Story:** Epic [#1619](https://github.com/Priivacy-ai/spec-kitty/issues/1619) (P0); mission `specify-protected-primary-coherence-01KVMBD6`; relates [#1716](https://github.com/Priivacy-ai/spec-kitty/issues/1716), [#1868](https://github.com/Priivacy-ai/spec-kitty/issues/1868)
