# ADR 2026-06-07-1: Execution-State Canonical Surface (`mission_runtime`)

**Date**: 2026-06-07
**Status**: Accepted
**Mission**: `execution-state-canonical-surface-01KTG6P9`
**Issues**: [#1619](https://github.com/Priivacy-ai/spec-kitty/issues/1619), [#1772](https://github.com/Priivacy-ai/spec-kitty/issues/1772)
