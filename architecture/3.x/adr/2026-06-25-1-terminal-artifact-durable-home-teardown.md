# ADR: Terminal-Artifact Durable Home + Topology-Aware Teardown Contract

**Date**: 2026-06-25
**Status**: Proposed (mission `retrospective-durable-home-01KVYM1W`, #2119)
**Mission**: `retrospective-durable-home-01KVYM1W` ("Teardown-Surface Hardening + Retrospective Durable Home")
**Requirement**: FR-011 (handle-safe seam, #2136 — the foundation) + FR-001/FR-002/FR-003 (placement) + FR-004/FR-005 (teardown), NFR-002 (live-coord proof) + NFR-005 (handle-equivalence)
**Module**: `src/mission_runtime/artifacts.py`, `src/specify_cli/missions/_read_path_resolver.py`,
