# ADR 2026-06-15-1: C-006 Amendment — Declarative `marketplace.json` Descriptor vs. Marketplace Publish

**Date**: 2026-06-15
**Status**: Accepted
**Mission**: `agent-profile-projection-plugin-production-01KV3NGS`
**Amends**: C-006 (FR-016 prohibition) from `tool-surface-contract-01KV2K2P`
**Issues**: relates to [#1968](https://github.com/Priivacy-ai/spec-kitty/issues/1968), [#1972](https://github.com/Priivacy-ai/spec-kitty/issues/1972)
