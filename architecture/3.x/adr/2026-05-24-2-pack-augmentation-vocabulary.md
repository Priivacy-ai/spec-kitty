# ADR: Pack Augmentation Vocabulary — `overrides` and `enhances` as Declarative Fields

**Date**: 2026-05-24
**Status**: Accepted
**Mission**: `charter-ux-and-org-pack-vocabulary-01KSAF14` (WP05)
**Requirement**: FR-010, FR-011
**Issue**: [Priivacy-ai/spec-kitty#1291](https://github.com/Priivacy-ai/spec-kitty/issues/1291)
**Module**: `src/doctrine/{tactics,styleguides,paradigms,procedures,agent_profiles}/`, `src/doctrine/schemas/`
**Predecessor**: [ADR 2026-05-16-1 — Doctrine Layer Merge Semantics](2026-05-16-1-doctrine-layer-merge-semantics.md)
**Cross-references**:
