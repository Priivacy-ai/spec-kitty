# ADR: Doctrine Layer Merge Semantics — Field-Level Merge with Collision Warnings

**Date**: 2026-05-16
**Status**: Accepted
**Mission**: `layered-doctrine-org-layer-01KRNPEE` (post-merge remediation)
**Requirement**: FR-001, FR-003 (reworded by this ADR), Mission-Review MEDIUM-1
**Module**: `src/doctrine/base.py`, `src/doctrine/agent_profiles/repository.py`
**Predecessor**: [Mission Review Report](../../../kitty-specs/layered-doctrine-org-layer-01KRNPEE/mission-review-report.md) — finding MEDIUM-1
