# ADR: Single-Authority Seam + Call-Site Gate for Resolution Boundaries (Phase 1)

**Status:** Proposed

**Date:** 2026-06-26

**Deciders:** Architect Alphonso (design), red-team / family-port / codebase-fit investigation squads (`docs/engineering_notes/2173-infra-logic-separation/00-SYNTHESIS.md`)

**Technical Story:** [#2173](https://github.com/Priivacy-ai/spec-kitty/issues/2173) (sub-issue of [#1619](https://github.com/Priivacy-ai/spec-kitty/issues/1619)); bug instances [#2164](https://github.com/Priivacy-ai/spec-kitty/issues/2164) (write-leg fold divergence) and the [#2160](https://github.com/Priivacy-ai/spec-kitty/issues/2160) class (mark-status / move-task / safe_commit writing the wrong surface)

**Predecessors:** [ADR 2026-06-24-1 — Kind- and Topology-Aware Artifact Placement](2026-06-24-1-kind-and-topology-aware-artifact-placement.md) · [ADR 2026-06-22-1 — MissionTopology SSOT](2026-06-22-1-mission-topology-ssot.md) · [ADR 2026-06-24-2 — Write-Branch Resolution Anchors on the PRIMARY Surface](2026-06-24-2-write-branch-resolution-primary-anchor.md)

**Prior art (the pattern this generalizes):** [`tests/architectural/test_protection_resolver_call_sites.py`](../../../tests/architectural/test_protection_resolver_call_sites.py) — single-authority free function + AST call-site gate (FR-010 / #1868)
