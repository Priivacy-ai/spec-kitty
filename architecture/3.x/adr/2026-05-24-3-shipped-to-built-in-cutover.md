# ADR: `shipped` → `built-in` Vocabulary Cutover for Doctrine Layer Label

**Date**: 2026-05-24
**Status**: Accepted
**Mission**: `charter-ux-and-org-pack-vocabulary-01KSAF14` (WP07)
**Requirement**: FR-015, FR-016, FR-017
**Issue**: [Priivacy-ai/spec-kitty#1291](https://github.com/Priivacy-ai/spec-kitty/issues/1291)
**Module**: `src/doctrine/`, `src/specify_cli/charter_lint/`, `src/specify_cli/cli/commands/charter.py`, `src/specify_cli/cli/commands/profiles_cmd.py`, `src/charter/drg.py`
**Predecessors**:
