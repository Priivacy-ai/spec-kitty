...
| T024 | Extend `src/charter/activation/compiler.py::_default_doctrine_service` — candidate-list extension (FR-009) | WP04 | [D] |
| T025 | Extend `src/charter/activation/context.py::_build_doctrine_service` — same candidate-list extension | WP04 | [D] |
...
- [x] T024 Extend `src/charter/activation/compiler.py::_default_doctrine_service` (WP04)
- [x] T025 Extend `src/charter/activation/context.py::_build_doctrine_service` (WP04)
