...
### Included Subtasks
- [ ] T006 Implement `src/specify_cli/core/vcs/detection.py` with tool detection functions (is_jj_available, is_git_available, get_jj_version, get_git_version, detect_available_backends)
- [ ] T007 Implement `get_vcs()` factory function in detection.py
...
### Included Subtasks
- [ ] T010 Create `src/specify_cli/core/vcs/git.py` with GitVCS class skeleton
...
### Included Subtasks
- [ ] T018 Create `src/specify_cli/core/vcs/jujutsu.py` with JujutsuVCS class skeleton
