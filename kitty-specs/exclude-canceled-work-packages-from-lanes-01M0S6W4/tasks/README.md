...
branch_strategy: "Planning artifacts were generated on fix/exclude-canceled-work-packages-from-lanes; completed changes must merge back into fix/exclude-canceled-work-packages-from-lanes."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
