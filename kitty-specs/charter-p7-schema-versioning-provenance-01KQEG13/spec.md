...
3. The Phase 3 baseline for provenance (`src/charter/activation/synthesizer/synthesize_pipeline.py` ProvenanceEntry) is the starting point; hardening adds fields and promotes optionals to mandatories.
