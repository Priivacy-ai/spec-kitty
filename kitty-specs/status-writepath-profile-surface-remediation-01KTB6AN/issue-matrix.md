...
| #1663 | MissionRun → Mission back-reference | deferred-with-followup | Explicitly out of scope (spec.md Out of Scope). Follow-up: #1663 |
| #1664 | status/ import-boundary enforcement test | deferred-with-followup | Explicitly out of scope (sibling follow-up). Follow-up: #1664 |
