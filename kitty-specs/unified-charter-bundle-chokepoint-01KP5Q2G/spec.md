...
- **Migration `m_3_2_0_unified_bundle.py` does not exist** and the literal filename named in issue [#464](https://github.com/Priivacy-ai/spec-kitty/issues/464) is unavailable because the slots `3.2.0`, `3.2.1`, `3.2.2` are already taken on `main` by `m_3_2_0_update_planning_templates.py`, `m_3_2_1_strip_selection_config.py`, and `m_3_2_2_safe_globalize_commands.py`. The next free slot is `m_3_2_3_unified_bundle.py` (see Constraints C-008).
...
- **Not redesigning any migration already shipped.** `m_3_2_0_update_planning_templates.py`, `m_3_2_1_strip_selection_config.py`, `m_3_2_2_safe_globalize_commands.py`, and `m_3_1_1_charter_rename.py` are not reopened. The new migration takes the next free slot.
