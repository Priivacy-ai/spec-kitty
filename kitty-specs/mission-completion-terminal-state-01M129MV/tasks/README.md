...
branch_strategy: "Planning artifacts were generated on fix/mission-completion-terminal-state; completed changes must merge back into fix/mission-completion-terminal-state."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
