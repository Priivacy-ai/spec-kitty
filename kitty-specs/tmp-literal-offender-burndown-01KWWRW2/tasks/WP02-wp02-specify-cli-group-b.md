...
title: '/tmp burn-down: specify_cli group B'
dependencies: []
requirement_refs:
- FR-001
- FR-002
...
# WP02 – /tmp burn-down: specify_cli group B
...
## Commit
`git add <your files> && git commit -m "test(specify_cli): convert WP02 tests off literal /tmp (tmp_path/sentinels) — refs #1842"`
...
- 2026-07-06T23:17:54Z – claude – shell_pid=999281 – Assigned agent via action command
- 2026-07-06T23:33:44Z – claude – shell_pid=999281 – Moved to for_review
- 2026-07-06T23:51:13Z – user – shell_pid=999281 – Moved to approved
