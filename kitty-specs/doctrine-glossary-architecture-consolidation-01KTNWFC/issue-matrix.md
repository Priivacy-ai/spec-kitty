...
| #1397 | org-charter.yaml `extends:` additive multi-org config | fixed | WP08 (approved): canonical charter.activation.org_extends resolver, fail-closed cycles/missing-base, parallel DFS deleted; contract round-tripped against shipped model |
