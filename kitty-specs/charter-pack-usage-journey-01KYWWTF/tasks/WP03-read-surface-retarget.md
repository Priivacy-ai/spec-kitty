...
`src/charter/activation/context.py` (`build_charter_context` presence gate `:206`/`:236`; the prose/section readers
`:342-354`/prose body — **leave those on `CHARTER_MD`**), `src/charter/activation/context_json.py`
