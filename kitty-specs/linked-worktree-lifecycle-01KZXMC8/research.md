...
Выбрано: одна boundary сначала определяет допустимую Mission surface, затем передаёт выбранный root существующим identity и placement resolver. Это сохраняет Git-root семантику и делает конфликт явным.
