...
4. **Central JSON ownership manifest at `.kittify/skills-manifest.json`.** One source of truth for Spec-Kitty-owned files under `.agents/skills/`. Uses SHA-256 content hashes for drift detection. Matches our existing `.kittify/` pattern.
