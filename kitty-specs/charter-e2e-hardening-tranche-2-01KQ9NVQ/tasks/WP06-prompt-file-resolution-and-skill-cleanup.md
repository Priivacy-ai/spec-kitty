...
- 2026-04-28T11:24:27Z – claude:opus:reviewer-renata:reviewer – shell_pid=98259 – WP06 approved: prompt_file invariant enforced (non-empty + on-disk OR structured blocked); _build_prompt_or_error helper added; _build_prompt_safe kept as deprecated shim; 4/5 step-issue sites switched to or_error (composition-failure site at line 1688 already returned blocked, kept as _build_prompt_safe); SKILL.md workaround sections replaced with positive contract description; m_3_2_5_fix_prompt_file_workaround migration follows m_2_1_2 pattern using find_skill_files + canonical doctrine source; per-step-kind invariant tests cover discovery/research/documentation/implement/review plus negative + third-state-does-not-exist; tests/next 400 passed in 26s; no out-of-scope edits in WP06 commit (e61fbbbd touches only owned paths). --force used because move-task blocker is a gitignored auto-generated dossier snapshot in the planning repo.
