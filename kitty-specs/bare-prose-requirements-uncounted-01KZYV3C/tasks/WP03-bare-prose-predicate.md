...
- **Result, corrected post-execution (WP03 rework, post-review, issue #3396 — see
  `tracer-design-decisions.md`)**: re-verifying the shipped function against the live
  corpus, independently twice, found **1/368 = 0.27%** — not 9/368. The 9/368 and
  139/368 figures were measured during design against an earlier, broader prototype that
  lacked this function's per-line declared-shape skip rule; they describe that earlier
  predicate, not the one shipped here. The shipped docstring records 1/368 as this
  function's own measured rate and retains 9/368/139/368, explicitly labeled as the
  earlier prototype's historical figures — never as this function's own rate.
