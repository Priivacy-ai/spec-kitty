...
Land charter Standing Order 2's "campsite cleaning" FIRST commit: split the over-ceiling
`_validate_requirement_mapping` (`mission_finalize.py:621-677`, cyclomatic complexity
**16**, ceiling **15**, confirmed via `radon cc`) into a classification helper and a
