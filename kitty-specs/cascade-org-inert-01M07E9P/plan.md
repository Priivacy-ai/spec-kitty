...
- **Affected surfaces**: `src/specify_cli/cli/commands/charter/context.py` (the `context()` CLI
  ...
  `load_org_charter_json_block`), `src/charter/context.py` (`build_charter_context_json` — swap
