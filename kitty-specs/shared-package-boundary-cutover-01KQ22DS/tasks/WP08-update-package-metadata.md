...
- 2026-04-25T12:06:52Z – claude:opus-4.7:python-reviewer:reviewer – shell_pid=71774 – Approved: WP08 acceptance criteria all met. (1) pyproject.toml ranges exactly '>=4.0.0,<5.0.0' for events and '>=0.4,<0.5' for tracker. (2) spec-kitty-runtime absent from pyproject.toml deps and from uv.lock (grep -c = 0). (3) [tool.uv.sources] removed. (4) constraints.txt deleted. (5) uv.lock generated, tracked (gitignore exception added). (6) uv lock --check zero diff. (7) WP03 xfail markers removed; 12/12 architectural tests pass in 3.23s. Cross-WP edit on test_pyproject_shape.py is per WP03's design contract. Refs: FR-006, FR-007, FR-008, FR-013, NFR-005, commit b294392a.
- 2026-04-25T12:18:03Z – claude:opus-4.7:python-reviewer:reviewer – shell_pid=71774 – Done override: post-merge
