...
- 2026-04-25T12:00:59Z – claude:opus-4.7:python-reviewer:reviewer – shell_pid=70069 – Approved: WP06 acceptance criteria all met. (1) tests/contract/test_packaging_no_vendored_events.py exists with both T025 wheel-shape assertion (distribution-marked) and T026 filesystem assertion (no marker, fast gate). (2) Both pass against post-WP05 tree (full module 1.92s, filesystem assertion <0.2s). (3) Markers correctly applied: filesystem = no marker (fast gate), wheel-shape = distribution. (4) Negative-probe is by construction (Path.exists() and substring match — hard-failing on reintroduction). Refs: FR-012, FR-019, commit ed627332.
- 2026-04-25T12:17:58Z – claude:opus-4.7:python-reviewer:reviewer – shell_pid=70069 – Done override: post-merge
