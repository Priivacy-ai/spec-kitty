...
|---|---|---|---|
| Policy, engine, aggregation, registry, public command | Integrated focused suite across the mission-owned review and CLI surfaces | 184 passed, 2 expected platform skips after final adversarial remediation. | Local platform is macOS; platform-specific skips are reported separately. |
