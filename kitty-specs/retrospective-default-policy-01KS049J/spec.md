...
| Mission boundary | A point in the mission lifecycle where retrospective policy is evaluated. Today's only mission boundary is "mission completion" as defined above. The term anticipates future boundaries (e.g. per-WP retrospectives) without committing to them in this release. |
