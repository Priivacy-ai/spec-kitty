...
owned_files:
- docs/how-to/diagnose-installation.md
- docs/how-to/toc.yml
...
- 2026-03-22T15:06:39Z – coordinator – shell_pid=21973 – lane=approved – Review passed: docs-only changes, correct files, toc updated
