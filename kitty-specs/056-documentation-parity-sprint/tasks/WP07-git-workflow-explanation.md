...
owned_files:
- docs/explanation/git-workflow.md
- docs/explanation/git-worktrees.md
- docs/explanation/toc.yml
- src/doctrine/skills/spec-kitty-git-workflow/SKILL.md
wp_code: WP07
---
...
- 2026-03-22T15:06:41Z – coordinator – shell_pid=21973 – lane=approved – Review passed: docs-only changes, correct files, toc updated
