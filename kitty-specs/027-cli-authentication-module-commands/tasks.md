...
### Included Subtasks
- [ ] T020 Create unit tests for `CredentialStore` in `tests/sync/test_credentials.py`
- [ ] T021 Create unit tests for `AuthClient` in `tests/sync/test_auth.py`
- [ ] T022 Create integration tests for CLI commands in `tests/cli/test_auth_commands.py`
