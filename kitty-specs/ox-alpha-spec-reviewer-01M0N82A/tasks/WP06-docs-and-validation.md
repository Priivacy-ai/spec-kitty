...
- 2026-08-24 – codex – T031: пользователь вручную выполнил внешний вызов exact Ox Alpha route; два ответа `Rate limit exceeded`. Это не пройденный live smoke: валидированного ответа модели и review-артефакта нет, покупок и изменений настроек не было, автоматический retry не выполнялся.
