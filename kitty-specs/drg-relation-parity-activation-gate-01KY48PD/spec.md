...
| C-004 | Single resolver, reused | No competing stem→canonical resolver is introduced; the gate reuses `charter.activation.kind_vocabulary.resolve_artifact_urn`. | Technical | Medium | Open |
