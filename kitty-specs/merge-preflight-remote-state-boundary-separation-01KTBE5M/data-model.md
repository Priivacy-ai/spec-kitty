...
TargetBranchSyncStatus
  ...
  is_safe_to_push: bool       # NEW: True for in_sync, ahead, no_tracking_branch; False for diverged
...
- `"behind"` → push will be rejected by git; preflight does NOT block (warn only)
