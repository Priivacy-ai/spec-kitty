...
- **Scenario 1 + 2** → [`Priivacy-ai/spec-kitty#1142`](https://github.com/Priivacy-ai/spec-kitty/issues/1142). Operator commitment: investigate within 7 days post-merge of the rc bump; if confirmed as hypothesis-1 (canary venv staleness), close with the venv-rebuild fix in the canary repo. If hypothesis-2 (WP01 predicate doesn't cover all lifecycle emitters), open a follow-up 1-WP mission against the WP01 surface.
