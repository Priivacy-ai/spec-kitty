...
- 2026-04-26T09:32:09Z – claude:opus-4-7:reviewer:reviewer – shell_pid=23647 – Review passed: 7/7 subtasks fixed. New auth transport, replay collision distinctions, bounded tracker retry. tracker/saas_client.py migration to AuthenticatedClient deferred-with-followup (130+ test mocks); architectural test enforces no-new-direct-httpx outside the documented 3-entry allowlist. ADR-2026-04-26-2 committed. Dossier snapshot is gitignored (untracked, not part of source).
