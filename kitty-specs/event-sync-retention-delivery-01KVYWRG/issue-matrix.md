...
| #2165 | Docs reorganization context — acknowledged, out of mission scope | deferred-with-followup | spec.md L8 ("acknowledged as docs-reorg context but does not move this mission's artifacts") |
| #2131 | Multi-target fan-out — declined for MVP (single active target) | deferred-with-followup | spec.md L128 C-003 (fan-out declined; ledger schema kept extensible for later many-targets) |
