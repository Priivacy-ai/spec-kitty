...
PROMOTED. Canonical reference: [`architecture/2.x/adr/2026-05-14-1-stale-lane-auto-rebase-classifier-policy.md`](../../../architecture/2.x/adr/2026-05-14-1-stale-lane-auto-rebase-classifier-policy.md) (status: ACCEPTED, 2026-05-14). The three open questions above were resolved per the Pedro recommendations recorded in the ADR's "Resolved questions" section. This draft is retained for historical traceability only; all future amendments belong on the ADR.
