...
branch_strategy: "Planning artifacts were generated on fix/operator-config-ergonomics; completed changes must merge back into fix/operator-config-ergonomics."
subtasks:
  - "T001"
  - "T002"
phase: "Phase 1 - Setup"
