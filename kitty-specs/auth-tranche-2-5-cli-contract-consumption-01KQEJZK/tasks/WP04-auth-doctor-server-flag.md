...
branch_strategy: All changes land on auth-tranche-2-5-cli-contract-consumption. Execution worktree is allocated per lane from lanes.json. WP04 runs in parallel with Lane A (WP02/WP03).
subtasks:
- T014
- T015
- T016
