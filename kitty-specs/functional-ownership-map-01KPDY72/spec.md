...
|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| C-001  | The mission does **not** bump the project version. `pyproject.toml` `version = "3.1.6"` is untouched. The upstream maintainers cut the 3.3.0 release that formally ships this removal.           | Confirmed |
