...
- T034: focused tests for the module-private helpers extracted out of
  ``_mt_commit_wp_file`` (folds #2604).
...
a checkbox rewrite. The T032/T035 classes that pinned that deleted surface are
removed here; the surviving commit-wp-file and param-object pins are retained.
"""
