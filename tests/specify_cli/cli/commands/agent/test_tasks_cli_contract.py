...
WP01 of the ``tasks-py-degod`` mission (FR-001 / C-004 / NFR-001) EXTENDS this
harness -- the sections below the original ``__init__`` #2114 contract close the
gaps its docstring punted:
