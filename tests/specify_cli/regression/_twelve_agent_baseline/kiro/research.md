...
**Path reference rule:** When you mention directories or files, provide either the absolute path or a path relative to the project<!-- glossary:glossary:project --> root (for example, `kitty-specs/<feature>/tasks/`). Never refer to a folder by name alone.
...
**BEFORE PROCEEDING:** Verify you are working in the repository<!-- glossary:glossary:repository --> root checkout<!-- glossary:glossary:repository-root-checkout -->.
...
**Before this**: `/spec-kitty.plan` calls this as "Phase<!-- glossary:glossary:phase --> 0" research phase
