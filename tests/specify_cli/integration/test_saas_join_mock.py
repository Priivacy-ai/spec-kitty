...
def test_join_mission_integration(respx_mock: respx.MockRouter):
...
@pytest.mark.respx(base_url="https://api.example.com")
def test_join_mission_404_error(respx_mock: respx.MockRouter):
...
@pytest.mark.respx(base_url="https://api.example.com")
def test_join_mission_401_unauthorized(respx_mock: respx.MockRouter):
...
@pytest.mark.respx(base_url="https://api.example.com")
def test_join_mission_500_server_error(respx_mock: respx.MockRouter):
