...
def test_real_typer_app_visible_count_within_tolerance() -> None:
    ...
    Expected from ``cli-audit-3-2.md``: 192 visible / 5 hidden / 2 deprecated.
    Tolerance: ±10% on the visible count (173..211) to allow natural growth.
    """
