...
class TestResearchImplementCommand:
    ...
    def test_implement_shows_deliverables_path(self, mock_slug: Mock, mock_root: Mock, research_task_file: Path):
        ...
        assert (
            "docs/research/008-research-feature/" in result.stdout or "research deliverables" in result.stdout.lower()
        )

    @patch("specify_cli.cli.commands.agent.workflow.locate_project_root")
    @patch("specify_cli.cli.commands.agent.workflow._find_feature_slug")
    def test_implement_warns_about_kitty_specs(self, mock_slug: Mock, mock_root: Mock, research_task_file: Path):
    ...
    @patch("specify_cli.cli.commands.agent.workflow.locate_project_root")
    @patch("specify_cli.cli.commands.agent.workflow._find_feature_slug")
    def test_implement_detects_research_mission(self, mock_slug: Mock, mock_root: Mock, research_task_file: Path):
...
class TestResearchMissionDetection:
    ...
    @patch("specify_cli.cli.commands.agent.workflow.locate_project_root")
    @patch("specify_cli.cli.commands.agent.workflow._find_feature_slug")
    def test_software_dev_does_not_show_deliverables(self, mock_slug: Mock, mock_root: Mock, tmp_path: Path):
        ...
        meta_file = feature_dir / "meta.json"
        meta_file.write_text(json.dumps({"mission": "software-dev", "slug": "008-sw-feature"}))
...
class TestDeliverablesPathInPrompt:
    ...
    @patch("specify_cli.cli.commands.agent.workflow.locate_project_root")
    @patch("specify_cli.cli.commands.agent.workflow._find_feature_slug")
    def test_default_deliverables_path_when_not_in_meta(self, mock_slug: Mock, mock_root: Mock, tmp_path: Path):
