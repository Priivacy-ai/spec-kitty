...
_CATEGORY_B_GRANDFATHERED_LEGACY: frozenset[str] = frozenset(
    {
        ...
        "runtime.next._internal_runtime.events::DecisionInputAnsweredPayload",
        "runtime.next._internal_runtime.events::DecisionInputRequestedPayload",
        "runtime.next._internal_runtime.events::JsonlEventLog",
        "runtime.next._internal_runtime.events::MissionRunCompletedPayload",
        "runtime.next._internal_runtime.events::MissionRunStartedPayload",
        "runtime.next._internal_runtime.events::NextStepAutoCompletedPayload",
        "runtime.next._internal_runtime.events::NextStepIssuedPayload",
