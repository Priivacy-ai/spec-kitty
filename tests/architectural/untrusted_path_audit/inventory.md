...
- **Deferred (CLI-arg, low-risk) → follow-up #2037:** `cli/commands/agent/mission_finalize.py:199`,
  `cli/commands/agent/tasks_move_task.py:204`, `cli/commands/decision.py:464`,
