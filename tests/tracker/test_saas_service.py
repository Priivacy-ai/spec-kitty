...
class TestReportBindingUpgrade:
    def test_changed_binding_ref_reports_without_writing(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_no_binding_ref_noop(self, service: SaaSTrackerService, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_already_current_is_noop(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_read_path_never_calls_save(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_partial_response_display_label_only_does_not_persist(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_reported_after_sync_pull(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_reported_after_sync_push(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_reported_after_sync_run(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_reported_after_map_list_on_result(self, repo_root: Path, mock_client: MagicMock) -> None:
...
class TestApplyBindingUpgrade:
    def test_apply_persists_and_preserves_extra_fields(self, repo_root: Path, mock_client: MagicMock) -> None:
    ...
    def test_apply_failure_preserves_in_memory_config(self, repo_root: Path, mock_client: MagicMock) -> None:
