...
- **Stat**: `docs/reference/cli-commands.md` created (+362 lines); also created `docs/reference/agent-subcommands.md` (+433), `docs/reference/slash-commands.md` (+313), `docs/toc.yml` (+10).
- **Script / test / hook added to maintain freshness**: none. `git show --stat` lists only `docs/reference/*.md` and `docs/toc.yml`; no entries under `scripts/`, `tools/`, `tests/`, or `.github/`.
...
- **Representative lines from the diff** (file `docs/reference/cli-commands.md`):
...
- **Stat**: `docs/reference/cli-commands.md` only (+324 lines, no other paths touched).
- **Script / test / hook added to maintain freshness**: none. Stat shows only `docs/reference/cli-commands.md`.
...
- **Stat**: `docs/reference/cli-commands.md` only (+187 lines, no other paths).
...
- **Stat**: `docs/reference/cli-commands.md` (-281 / +many) plus `docs/how-to/install-and-upgrade.md`, `docs/how-to/install-spec-kitty.md`, `docs/index.md`. No `docfx.json` change is present in this commit; the truncated stat shows only docs/* files, no `scripts/`, `tools/`, `tests/`, or `.github/` entries.
- **Script / test / hook added to maintain freshness**: none.
...
1. **No generator script ever shipped.** Across all four commits the `--stat` output mentions only `docs/reference/*.md`, `docs/toc.yml`, and other prose markdown files. No path under `scripts/`, `tools/`, `tests/`, or `.github/workflows/` is touched by any of the four commits. A test-validated or generated approach would have required a checked-in producer or validator.
...
- `tests/contract/test_terminology_guards.py:279` references `docs/reference/cli-commands.md`.
- `tests/contract/test_terminology_guards.py:283` references `docs/reference/agent-subcommands.md`.
- `.github/`: **none found**.
...
WP06 implements the builder against all three modes. WP07 picks the mode used to rebuild `docs/reference/cli-commands.md` and `docs/reference/agent-subcommands.md`. This methodology note does not pick.
