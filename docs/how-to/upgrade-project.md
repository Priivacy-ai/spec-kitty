...
3. **Updates agent command directories** for configured agents only (`.claude/commands/`, `.codex/skills/`, `.amazonq/prompts/`, etc.). Agents you removed stay removed — migrations never recreate them.
