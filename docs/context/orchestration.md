...
| **Related terms** | [Routing](#routing) (the sync fan-out sense decides *whether* a checkout participates, never what "the drain" means), [Lane Consolidation](#lane-consolidation), [Mission](#mission) |
