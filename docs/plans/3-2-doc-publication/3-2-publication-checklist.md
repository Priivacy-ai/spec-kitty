...
|-----------|-----------------|
| **SC1** First mission in < 30 min on macOS | [`docs/guides/getting-started.md`](../../guides/getting-started.md), [`docs/guides/your-first-mission.md`](../../guides/your-first-mission.md), [`docs/guides/install-macos.md`](../../guides/install-macos.md), claude-code harness page. |
