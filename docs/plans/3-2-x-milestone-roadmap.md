...
1. **Mission 3 — `charter-sole-door-bypass-closure-01KZ3WAA` — landed 2026-08-04.** Ran the
   ...
   (`charter.activation.doctrine_service_builder.build_activation_aware_doctrine_service`); extended
