...
description: "Verbatim record of the operator's Emergent HiC/Operator design for a creed artefact, FoundationalValues type, value-impact deltas, and a generalized impacts edge — plus the corpus evidence measured against it."
doc_status: draft
updated: '2026-07-26'
related:
