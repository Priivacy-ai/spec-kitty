...
description: "Doctrine integrity review of the creed/FoundationalValues design: the per-kind exemption table, the value_impact vs value_bias split, accreditation placement, provenance shape, and the gates it trips."
doc_status: draft
updated: '2026-07-26'
related:
