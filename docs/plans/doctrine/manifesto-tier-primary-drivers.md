...
description: "Meta-level analysis: doctrine implements only the middle tier of a three-tier sense-making model, having inherited an upstream scope exclusion. AMMERSE is already in-repo but mis-tiered as a tactic. Proposes a manifesto tier as the arbitration basis."
doc_status: draft
updated: '2026-07-26'
related:
