...
description: "Executable delivery sequence: critical path with gate positions, 22 increments ranked by evidence-per-cost, the superseding-ADR scope, tracker shape, park register, upstream report, and effort envelope anchored on in-repo precedents."
doc_status: draft
updated: '2026-07-26'
related:
