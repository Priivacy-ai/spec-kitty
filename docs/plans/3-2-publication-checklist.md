...
|---|----------|-------------------|----------------------|--------|
| **S1** | Version separation at the entry page — 3.2 lands as `current`; 1.x/2.x is archive/migration. | [`docs/context/index.md`](../3x/index.md) (3.2 landing page from WP04), [`docs/development/3-2-version-taxonomy.md`](3-2-version-taxonomy.md), [`docs/development/3-2-navigation-plan.md`](3-2-navigation-plan.md), archive-notice banners enforced by [`scripts/docs/version_leakage_check.py`](../../scripts/docs/version_leakage_check.py) (`LEAK-*` rules). | `SPEC_KITTY_ENABLE_SAAS_SYNC=1 SPEC_KITTY_NO_UPGRADE_CHECK=1 PYTHONPATH=. uv run python scripts/docs/check_docs_freshness.py --ci --link-check none` | TBD |
